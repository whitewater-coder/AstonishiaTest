...
namespace Astonishia.Controls
{
    public class CustomBar : ProgressBar
    {
        ...
        private SolidBrush _progressBackgroundBrush = (SolidBrush)Brushes.Black;
        [Category("Additional Options"), Browsable(true), EditorBrowsable(EditorBrowsableState.Always)]
        ...
        public Color BackgroundColor
        {
            get
            {
                return _progressBackgroundBrush.Color;
            }
            set
            {
                _progressBackgroundBrush = new SolidBrush(value);
            }
        }
        ...
        private void DrawBackground(Graphics g)
        {
            ...
            g.FillRectangle(_progressBackgroundBrush, rect);
